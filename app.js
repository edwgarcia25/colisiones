...
iotfClient.on("connect", function () {
    ...
    setInterval(function(){
        ...
        //
        // Decrement espacioHorizontal up to 100 then back down to 0
        //
        //if (dataPacket.d.espacioHorizontal === 0) {
        //   var countingUp = true;
        //} else if (dataPacket.d.espacioHorizontal === 100) {
        //   var countingUp = false;
        //}
        //if (countingUp === true) {
        //    if (dataPacket.d.espacioHorizontal === 100) {
        //       var countingUp = false;
        //    } else1{
        //       var countingUp = true;
        //    }
        //    var espacioHorizontalDecrement = 20;
        //} else {
        //    if (dataPacket.d.espacioHorizontal === 0) {
        //       var countingUp = true
        //    } else {
        //       var countingUp = false;
        //    }
            var espacioHorizontalDecrement = 0.25;
            var espacioVerticasDecrement = 0.02;
          //  var luminosityDecrement = 1;
        //}
        //if (dataPacket.d.espacioHorizontal === 100) {
          //  dataPacket.d.espacioHorizontal = 0;
        //}
        dataPacket.d.espacioHorizontal = dataPacket.d.espacioHorizontal - espacioHorizontalDecrement;

        //if (dataPacket.d.humidity === 100) {
          //  dataPacket.d.humidity = 0;
        //}
        //dataPacket.d.humidity = dataPacket.d.humidity + espacioVerticasDecrement;


        //
        // Decrement the espacioVerticas until 100 and start again at 0
        //
        //var espacioVerticasDecrement = 1;
        //if (dataPacket.d.espacioVerticas === 100) {
          //  dataPacket.d.espacioVerticas = 0;
        //}
        dataPacket.d.espacioVerticas = dataPacket.d.espacioVerticas - espacioVerticasDecrement;
